...
## Tâches
  ...
  - [X] Permettre à l'utilisateur de créer une liste.
  - [X] Permettre à l'utilisateur de mettre une liste en favoris ou non. (5 maximums)
  - [X] Permettre à l'utilisateur de créer une tâche au sein d'un liste.
  - [X] Permettre à l'utilisateur de modifier si une tâche est faite ou non.
  - [X] Permettre à l'utilisateur de modifier une tâche.
  - [ ] Permettre à l'utilisateur d'ordonner les tâches. (Drag and drop)
  - [ ] Permettre à l'utilisateur de supprimer une tâche réalisé.
  - [X] Permettre à l'utilisateur de supprimer une liste vide de tâche.
